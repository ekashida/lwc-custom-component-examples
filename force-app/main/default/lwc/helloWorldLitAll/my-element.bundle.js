...
const getCompatibleStyle = supportsAdoptingStyleSheets ||
    (NODE_MODE$3 && global$2.CSSStyleSheet === undefined)
    ? (s) => s
...
const NODE_MODE$2 = false;
// Lets a minifier replace globalThis references with a minified name
const global$1 = globalThis;
if (NODE_MODE$2) {
    global$1.customElements ??= customElements;
}
const DEV_MODE$2 = true;
let issueWarning$2;
...
const emptyStringForBooleanAttribute = trustedTypes$1
    ...
    : '';
const polyfillSupport$2 = DEV_MODE$2
    ? global$1.reactiveElementPolyfillSupportDevMode
    : global$1.reactiveElementPolyfillSupport;
if (DEV_MODE$2) {
 ...
 */
const debugLogEvent$1 = DEV_MODE$2
    ? (event) => {
...
// shadowed by this import, so it no longer refers to the global.
 extends HTMLElement {
     ...
     */
    static __prepare() {
        if (this.hasOwnProperty(JSCompiler_renameProperty$1('elementProperties', this))) {
            // Already prepared
            return;
        }
    ...
    requestUpdate(name, oldValue, options) {
        ...
        if (name !== undefined) {
            if (DEV_MODE$2 && name instanceof Event) {
...
ReactiveElement[JSCompiler_renameProperty$1('elementProperties', ReactiveElement)] = new Map();
ReactiveElement[JSCompiler_renameProperty$1('finalized', ReactiveElement)] = new Map();
...
if (DEV_MODE$2) {
    ...
    const ensureOwnWarnings = function (ctor) {
        if (!ctor.hasOwnProperty(JSCompiler_renameProperty$1('enabledWarnings', ctor))) {
...
if (DEV_MODE$2 && global$1.reactiveElementVersions.length > 1) {
 ...
 * Compiled out of prod mode builds.
 */
const debugLogEvent = DEV_MODE$1
    ? (event) => {
...
const d = NODE_MODE$1 && global.document === undefined
    ? {
        createTreeWalker() {
            return {};
        },
...
const tag = (type) => (strings, ...values) => {
    ...
    // template definition.
    if (DEV_MODE$1 && strings.some((s) => s === undefined)) {
...
class ChildPart {
    ...
    _$setValue(value, directiveParent = this) {
        if (DEV_MODE$1 && this.parentNode === null) {
        ...
        if (isPrimitive(value)) {
            ...
            if (DEV_MODE$1 && this.options?.host === value) {
...
class EventPart extends AttributePart {
    constructor(element, name, strings, parent, options) {
        ...
        if (DEV_MODE$1 && this.strings !== undefined) {
...
// Apply polyfills if available
const polyfillSupport$1 = DEV_MODE$1
...
if (DEV_MODE$1 && global.litHtmlVersions.length > 1) {
...
const render = (value, container, options) => {
    ...
    const renderId = DEV_MODE$1 ? debugLogRenderId++ : 0;
